...
public class AddClientView {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddClientView window = new AddClientView();
	...
	private void initialize() {
		...
		JLabel lblTitle = new JLabel("Open New Account");
		...
		lblUsername.setBounds(235, 100, 86, 14);
		panelLogin.add(lblUsername);
		
		tfUsername = new JTextField();
		tfUsername.setBounds(370, 97, 156, 27);
		...
		lblPassword.setBounds(235, 157, 86, 14);
		...
		lblFirstName.setBounds(224, 268, 97, 14);
