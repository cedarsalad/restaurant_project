...
public class ViewDeliveriesView extends JFrame {
	...
	private JLabel viewDelivery_Label;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewDeliveriesView frame = new ViewDeliveriesView();
	...
	public ViewDeliveriesView() {
		...
		viewDelivery_Label = new JLabel("View Delivery");
		viewDelivery_Label.setHorizontalAlignment(SwingConstants.CENTER);
		viewDelivery_Label.setFont(new Font("Tahoma", Font.BOLD, 25));
		viewDelivery_Label.setPreferredSize(new Dimension(600, 40));
		centerNorth_Panel.add(viewDelivery_Label);
		...
		rigidArea_5.setBounds(5, 200, 230, 10);
